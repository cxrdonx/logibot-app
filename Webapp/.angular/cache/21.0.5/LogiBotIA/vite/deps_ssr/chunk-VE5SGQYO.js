...
var composeServiceApi = (transferHandler, serializer, deserializer, defaultConfig3) => {
  return async (config, input) => {
    ...
    const response = await transferHandler(request, __spreadValues({}, resolvedConfig));
...
var isSourceData = (body) => (
  ...
  body !== UNSIGNED_PAYLOAD && (typeof body === "string" || ArrayBuffer.isView(body) || isArrayBuffer2(body))
);
...
var createVerifySoftwareTokenClient = (config) => composeServiceApi(cognitoUserPoolTransferHandler, createUserPoolSerializer("VerifySoftwareToken"), createUserPoolDeserializer(), __spreadValues(__spreadValues({}, DEFAULT_SERVICE_CLIENT_API_CONFIG2), config));
...
async function handleWebAuthnSignInResult(challengeParameters) {
  ...
  if (authenticationResult) {
    await cacheCognitoTokens(__spreadProps(__spreadValues({}, authenticationResult), {
      username,
...
async function signInWithCustomAuth(input) {
  ...
  try {
    ...
    if (AuthenticationResult) {
      await cacheCognitoTokens(__spreadProps(__spreadValues({
        username: activeUsername
...
var createResendConfirmationCodeClient = (config) => composeServiceApi(cognitoUserPoolTransferHandler, createUserPoolSerializer("ResendConfirmationCode"), createUserPoolDeserializer(), __spreadValues(__spreadValues({}, DEFAULT_SERVICE_CLIENT_API_CONFIG2), config));
...
var createConfirmSignUpClient = (config) => composeServiceApi(cognitoUserPoolTransferHandler, createUserPoolSerializer("ConfirmSignUp"), createUserPoolDeserializer(), __spreadValues(__spreadValues({}, DEFAULT_SERVICE_CLIENT_API_CONFIG2), config));
...
var createSetUserMFAPreferenceClient = (config) => composeServiceApi(cognitoUserPoolTransferHandler, createUserPoolSerializer("SetUserMFAPreference"), createUserPoolDeserializer(), __spreadValues(__spreadValues({}, DEFAULT_SERVICE_CLIENT_API_CONFIG2), config));
...
var createUpdateUserAttributesClient = (config) => composeServiceApi(cognitoUserPoolTransferHandler, createUserPoolSerializer("UpdateUserAttributes"), createUserPoolDeserializer(), __spreadValues(__spreadValues({}, DEFAULT_SERVICE_CLIENT_API_CONFIG2), config));
...
var createDeleteUserAttributesClient = (config) => composeServiceApi(cognitoUserPoolTransferHandler, createUserPoolSerializer("DeleteUserAttributes"), createUserPoolDeserializer(), __spreadValues(__spreadValues({}, DEFAULT_SERVICE_CLIENT_API_CONFIG2), config));
...
var createUpdateDeviceStatusClient = (config) => composeServiceApi(cognitoUserPoolTransferHandler, createUserPoolSerializer("UpdateDeviceStatus"), createUserPoolDeserializer(), __spreadValues(__spreadValues({}, DEFAULT_SERVICE_CLIENT_API_CONFIG2), config));
...
var createForgetDeviceClient = (config) => composeServiceApi(cognitoUserPoolTransferHandler, createUserPoolSerializer("ForgetDevice"), createEmptyResponseDeserializer(), __spreadValues(__spreadValues({}, DEFAULT_SERVICE_CLIENT_API_CONFIG2), config));
...
var createListDevicesClient = (config) => composeServiceApi(cognitoUserPoolTransferHandler, createUserPoolSerializer("ListDevices"), createUserPoolDeserializer(), __spreadValues(__spreadValues({}, DEFAULT_SERVICE_CLIENT_API_CONFIG2), config));
...
//# sourceMappingURL=chunk-VE5SGQYO.js.map
